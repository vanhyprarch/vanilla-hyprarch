...
hardware/pairing matrix remain pending, and the planned Super+Space menu,
screenshot-to-clipboard workflow, and local F9 push-to-talk dictation are not
implemented. The detailed status and roadmap are in
